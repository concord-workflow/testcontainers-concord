...
public class Concord<T extends Concord<T>> implements AutoCloseable {
    ...
    private List<Mount> agentBindMounts;
    ...
    public T agentBindMount(String source, String dest) {
        ...
        this.agentBindMounts.add(new Mount(source, dest));
        return (T) this;
    }

    public List<Mount> getAgentBindMounts() {
    ...
    public static class Mount {
        ...
        public Mount(String source, String dest) {
            this.source = source;
            this.dest = dest;
        }
